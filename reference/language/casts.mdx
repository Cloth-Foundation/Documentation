...
| class C | interface I | OK iff C transitively implements I (upcast) |
| interface I | class C | OK iff C transitively implements I (downcast) |
| interface I1 | interface I2 | OK; assignability honors the inheritance chain |
