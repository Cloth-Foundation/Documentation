...
A pattern is any expression of the discriminant's type. The compiler lowers each case to an equality comparison: integer and pointer discriminants use `icmp eq`, floating-point discriminants use `fcmp oeq`, and enum-typed discriminants compare singleton pointers (see [Enums](/docs/reference/language/interfaces-traits-enums#enums)).
