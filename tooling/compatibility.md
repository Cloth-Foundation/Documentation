...
Shuttle advertises and validates artifact format 6 through public capabilities
and receipts. Runtime ABI 7 is compiler-owned metadata inside the opaque
