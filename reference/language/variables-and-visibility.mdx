...
Bindings are non-nullable by default. To allow `null`, declare the type with the `?` postfix; see [Nullability](/docs/reference/language/nullable) for the full rules.
